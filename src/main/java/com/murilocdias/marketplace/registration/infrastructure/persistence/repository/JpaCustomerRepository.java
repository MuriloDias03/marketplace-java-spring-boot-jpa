...
public class JpaCustomerRepository implements CustomerRepository {
    ...
    private static com.murilocdias.marketplace.registration.infrastructure.persistence.entity.Customer mapper(Customer customer) {
        var entity = new com.murilocdias.marketplace.registration.infrastructure.persistence.entity.Customer();
    ...
    private static Customer mapper(com.murilocdias.marketplace.registration.infrastructure.persistence.entity.Customer entity) {
