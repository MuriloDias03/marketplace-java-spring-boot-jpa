package com.murilocdias.marketplace.registration.infrastructure;
...
@EnableJpaRepositories(
        basePackages = "com.murilocdias.marketplace.registration",
...
public class RegistrationConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean registrationEntityManagerFactory(DataSource dataSource, JpaProperties jpaProperties) {
        ...
        return builder
                ...
                .packages("com.murilocdias.marketplace.registration")
